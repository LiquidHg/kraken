...
v0.2.1: Commented AssemblyFileVersion since it seems to cause grief for SharePoint event receivers.
v0.2.0: Updating all core libs to same nuget release number
v0.1.3: Brings this package current with other Nuget packages.
v0.1.2: Skipped to bring version number into line with other packages.
