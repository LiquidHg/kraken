...
namespace Kraken.SharePoint.Client.Files
{
    public class WebDAVFileUploader : BaseFileUploader
    {
        ...
        protected virtual void DoUploadImpl(string fileUrl, System.IO.FileStream fstream)
        {
    ...
    public class WebDAVTimeoutFileUploader : WebDAVFileUploader
    {
        ...
        protected override void DoUploadImpl(string fileUrl, System.IO.FileStream fstream)
        {
          int estTimeOut = (int)GetEstimateUploadTime(Params.LocalPath.FileInfo);
