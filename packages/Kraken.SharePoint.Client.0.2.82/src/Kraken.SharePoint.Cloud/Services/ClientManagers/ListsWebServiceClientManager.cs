...
namespace Kraken.SharePoint.Cloud.Client {
  ...
  public class ListsWebServiceClientManager : WebServiceClientManager<ListsWS.Lists> {
    ...
    public XElement UpdateListSchema(string listName, XElement newListSchema, bool includeFields = true) {
      return UpdateListSchema(listName, null, newListSchema, includeFields);
    }
    /// <summary>
    ...
    /// Validation.Formula
    /// </remarks>
    public XElement UpdateListSchema(string listName, XElement currentListSchema, XElement newListSchema, bool includeFields = true) {
