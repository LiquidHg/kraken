  ...
  public class LookupFieldProvisioner {
    ...
    */
    ...
    private void AddAdditionalFields(Field primaryLookupField, ClientContext lookupClientContext, List lookupList, FieldProperties properties) {
      ...
      //properties.ListId = null;
      //properties.LookupAdditionalFields = null;
      ...
      if (addFields != null && addFields.Count > 0) {
        ...
        foreach (Field field in addFields) {
          string newLookupFieldName = string.Format("{0}_{1}", primaryLookupField.InternalName, field.InternalName);
          string newLookupFieldTitle = string.Format("{0} : {1}", primaryLookupField.InternalName, field.InternalName);
