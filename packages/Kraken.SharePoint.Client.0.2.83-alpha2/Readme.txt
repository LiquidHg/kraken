...
v0.2.83-alpha1: Experimental build to make it possible to set NavigateForFormsPages in Lists using legacy web service calls.
v0.2.82: Expanded ListOptions and List.Update() to include DefaultContentType and DocumentTemplateType is now [better] implemented.
