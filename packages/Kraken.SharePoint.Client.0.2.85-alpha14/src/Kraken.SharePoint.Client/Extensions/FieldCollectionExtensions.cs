namespace Microsoft.SharePoint.Client {
  ...
  public static class KrakenFieldCollectionExtensions {
    ...
    /// <returns></returns>
    public static Field FindFirst(this IEnumerable<Field> fields, string identifier) {
    ...
    /// <param name="identifier"></param>
    /// <returns></returns>
    public static IEnumerable<Field> FindAny(this IEnumerable<Field> fields, string identifier) {
    ...
    /// <returns></returns>
    public static IEnumerable<Field> FindAny(this IEnumerable<Field> fields, IEnumerable<string> identifier) {
      List<Field> matchedFields = new List<Field>();
      foreach (string id in identifier) {
        var matches = FindAny(fields, id);
        if (matches != null)
    ...
    public static IEnumerable<Field> FindByGroup(this FieldCollection fields, string groupName, bool excludeBuiltInFields = false) {
      ...
      IEnumerable<Field> result =
        context.LoadQuery(
          ...
          : fields.Where(
            f => groupName.Equals(f.Group, StringComparison.InvariantCultureIgnoreCase))
    ...
    public static IEnumerable<Field> GetAllFields(this FieldCollection fields, bool excludeBuiltInFields = false) {
      ...
      IEnumerable<Field> result =
        context.LoadQuery(
          ((excludeBuiltInFields) ? fields.Where(f => !f.IsBuiltIn()) : fields)
          .IncludeKeyProperties()
        );
      context.ExecuteQuery();
      return result;
    ...
    /// <returns></returns>
    public static Field FindField(this FieldCollection fields, string identifier, FieldFindMethod findMethod = FieldFindMethod.Any) {
      ClientContext context = (ClientContext)fields.Context;
      Field field = null;
    ...
    public static Field FindField(this FieldCollection fields, Guid uniqueId) {
      ClientContext context = (ClientContext)fields.Context;
    ...
    public static void EnsureKeyProperties(this IEnumerable<Field> fields, ClientContext ctx = null) {
    ...
    public static void EnsureKeyProperties(this FieldCollection fields, List<Field> fieldRefs = null) {
      // ensure we have properties we'll need
      ClientContext ctx = (ClientContext)fields.Context;
      ctx.Load(fields, fc => fc.Include(
        f => f.InternalName, f => f.Title, f => f.Id, f => f.Group, f => f.TypeAsString, f => f.FromBaseType, f => f.EntityPropertyName, f => f.SchemaXml
      ));
      if (fieldRefs != null)
        EnsureKeyProperties(fieldRefs, ctx);
      ctx.ExecuteQueryIfNeeded();
    }
    ...
    public static string CanonicalizeFormula(this FieldCollection fields, string formula, List<Field> fieldRefs, ITrace trace = null) {
      ...
      fields.EnsureKeyProperties(fieldRefs);
      ...
      foreach (Match m in matches) {
        ...
        Field f = fields.FindFirst(fieldTitle);
        if (f == null)
      ...
      foreach (Field f2 in fields) {
        ...
        if (isFieldInFormula && fieldRefs.FindFirst(fieldName) == null)
          fieldRefs.Add(f2);
      }
    ...
    public static List<Field> GetLookupSupportedFields(this FieldCollection fields, ITrace trace = null) {
      ...
      supportedFields.EnsureKeyProperties();
