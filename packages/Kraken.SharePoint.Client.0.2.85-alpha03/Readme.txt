...
v0.2.85-alpha03: Fixed problems with field properties not being loaded during canonicalization of formulas when creating site columns and in creation of extra fields for lookup columns. Added some useful methods to FieldUtility class.
