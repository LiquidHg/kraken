...
$SlnName_Farm = "Kraken.SPFarmLibrary.wsp"
...
$wspPath = "$(Get-ScriptDirectory)\SP$SPVersion\$SlnName\"
$wspPath_Farm14 = "$wspPath\$SlnName_Farm"
$wspPath_Logging = "$wspPath\$SlnName_Logging"
