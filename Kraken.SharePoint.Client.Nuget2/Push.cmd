...
SET NUGET_PUSH_FN = .\bin\Release\Kraken.SharePoint.Client.0.2.2.symbols.nupkg
nuget push %NUGET_PUSH_FN% -Source https://liquidhg.pkgs.visualstudio.com/DefaultCollection/_packaging/Misc/nuget/v2 -ApiKey VSTS
