...
namespace Kraken.SharePoint.Client {
  ...
  public sealed class BuiltInFieldId {

    private static Dictionary<Guid, string> s_dict = null;
    ...
    public static string GetName(Guid fid) {
      EnsureItems();
      string name;
      if (s_dict.TryGetValue(fid, out name))
        return name;
      else
        return string.Empty;
    }
    private static void EnsureItems() {
      if (s_dict == null) {
        s_dict = new Dictionary<Guid, string>(440);
        s_dict[DisplayTemplateJSTargetListTemplate] = "DisplayTemplateJSTargetListTemplate";
        s_dict[Editor] = "Editor";
        s_dict[WebPage] = "WebPage";
        s_dict[Profession] = "Profession";
        s_dict[IsNonWorkingDay] = "IsNonWorkingDay";
        s_dict[CallTime] = "CallTime";
        s_dict[ImageHeight] = "ImageHeight";
        s_dict[EndDate] = "EndDate";
        s_dict[Modified_x0020_By] = "Modified_x0020_By";
        s_dict[Last_x0020_Modified] = "Last_x0020_Modified";
        s_dict[ThumbnailExists] = "ThumbnailExists";
        s_dict[RelevantMessages] = "RelevantMessages";
        s_dict[ContentLanguages] = "ContentLanguages";
        s_dict[MiddleName] = "MiddleName";
        s_dict[HolidayWork] = "HolidayWork";
        s_dict[AllowEditing] = "AllowEditing";
        s_dict[HealthReportSeverity] = "HealthReportSeverity";
        s_dict[_EditMenuTableEnd] = "_EditMenuTableEnd";
        s_dict[OffsiteParticipant] = "OffsiteParticipant";
        s_dict[CallBack] = "CallBack";
        s_dict[Location] = "Location";
        s_dict[Comments] = "Comments";
        s_dict[ParentID] = "ParentID";
        s_dict[OtherAddressCity] = "OtherAddressCity";
        s_dict[LinkIssueIDNoMenu] = "LinkIssueIDNoMenu";
        s_dict[Created_x0020_Date] = "Created_x0020_Date";
        s_dict[Gender] = "Gender";
        s_dict[WorkflowDisplayName] = "WorkflowDisplayName";
        s_dict[SpouseName] = "SpouseName";
        s_dict[Service] = "Service";
        s_dict[Date] = "Date";
        s_dict[HTML_x0020_File_x0020_Type] = "HTML_x0020_File_x0020_Type";
        s_dict[Resolved] = "Resolved";
        s_dict[User] = "User";
        s_dict[RelatedItems] = "RelatedItems";
        s_dict[URL] = "URL";
        s_dict[Detail] = "Detail";
        s_dict[RecurrenceID] = "RecurrenceID";
        s_dict[AppAuthor] = "AppAuthor";
        s_dict[HealthRuleSchedule] = "HealthRuleSchedule";
        s_dict[ParentItemEditor] = "ParentItemEditor";
        s_dict[DLC_Duration] = "DLC_Duration";
        s_dict[HomeAddressStateOrProvince] = "HomeAddressStateOrProvince";
        s_dict[Company] = "Company";
        s_dict[Until] = "Until";
        s_dict[CheckoutUser] = "CheckoutUser";
        s_dict[ThreadingControls] = "ThreadingControls";
        s_dict[FirstName] = "FirstName";
        s_dict[From] = "From";
        s_dict[DefaultCssFile] = "DefaultCssFile";
        s_dict[DiscussionTitle] = "DiscussionTitle";
        s_dict[FullBody] = "FullBody";
        s_dict[WorkflowVersion] = "WorkflowVersion";
        s_dict[VirusStatus] = "VirusStatus";
        s_dict[FirstNamePhonetic] = "FirstNamePhonetic";
        s_dict[DisplayTemplateJSIconUrl] = "DisplayTemplateJSIconUrl";
        s_dict[End] = "End";
        s_dict[EncodedAbsThumbnailUrl] = "EncodedAbsThumbnailUrl";
        s_dict[Description] = "Description";
        s_dict[DisplayTemplateJSTargetContentType] = "DisplayTemplateJSTargetContentType";
        s_dict[V4HolidayDate] = "V4HolidayDate";
        s_dict[EmailSubject] = "EmailSubject";
        s_dict[IMEComment1] = "IMEComment1";
        s_dict[ThreadTopic] = "ThreadTopic";
        s_dict[List] = "List";
        s_dict[Oof] = "Oof";
        s_dict[ContactInfo] = "ContactInfo";
        s_dict[SendEmailNotification] = "SendEmailNotification";
        s_dict[_HasCopyDestinations] = "_HasCopyDestinations";
        s_dict[ParentFolderId] = "ParentFolderId";
        s_dict[NoCodeVisibility] = "NoCodeVisibility";
        s_dict[AttendeeStatus] = "AttendeeStatus";
        s_dict[PercentComplete] = "PercentComplete";
        s_dict[Body] = "Body";
        s_dict[HealthReportCategory] = "HealthReportCategory";
        s_dict[_CheckinComment] = "_CheckinComment";
        s_dict[_Revision] = "_Revision";
        s_dict[Expires] = "Expires";
        s_dict[Email2] = "Email2";
        s_dict[HomeAddressCity] = "HomeAddressCity";
        s_dict[Whereabout] = "Whereabout";
        s_dict[ComputerNetworkName] = "ComputerNetworkName";
        s_dict[File_x0020_Type] = "File_x0020_Type";
        s_dict[Out] = "Out";
        s_dict[AdminTaskDescription] = "AdminTaskDescription";
        s_dict[RelatedIssues] = "RelatedIssues";
        s_dict[DisplayTemplateJSConfigurationUrl] = "DisplayTemplateJSConfigurationUrl";
        s_dict[_ModerationStatus] = "_ModerationStatus";
        s_dict[DisplayTemplateJSTargetScope] = "DisplayTemplateJSTargetScope";
        s_dict[ParentItemID] = "ParentItemID";
        s_dict[WorkflowItemId] = "WorkflowItemId";
        s_dict[ShortestThreadIndexIdLookup] = "ShortestThreadIndexIdLookup";
        s_dict[Workspace] = "Workspace";
        s_dict[OrganizationalIDNumber] = "OrganizationalIDNumber";
        s_dict[ScheduledWork] = "ScheduledWork";
        s_dict[Role] = "Role";
        s_dict[MobilePhone] = "MobilePhone";
        s_dict[Break] = "Break";
        s_dict[IMEComment3] = "IMEComment3";
        s_dict[RadioNumber] = "RadioNumber";
        s_dict[SipAddress] = "SipAddress";
        s_dict[_Comments] = "_Comments";
        s_dict[GoFromHome] = "GoFromHome";
        s_dict[HealthRuleReportLink] = "HealthRuleReportLink";
        s_dict[ReferredBy] = "ReferredBy";
        s_dict[GoingHome] = "GoingHome";
        s_dict[WorkState] = "WorkState";
        s_dict[ImageWidth] = "ImageWidth";
        s_dict[ShortestThreadIndexId] = "ShortestThreadIndexId";
        s_dict[UserField4] = "UserField4";
        s_dict[_Publisher] = "_Publisher";
        s_dict[ThreadIndex] = "ThreadIndex";
        s_dict[WorkflowOutcome] = "WorkflowOutcome";
        s_dict[AssignedTo] = "AssignedTo";
        s_dict[SelectedFlag] = "SelectedFlag";
        s_dict[Keywords] = "Keywords";
        s_dict[SelectTitle] = "SelectTitle";
        s_dict[HomeAddressStreet] = "HomeAddressStreet";
        s_dict[ID] = "ID";
        s_dict[Thumbnail] = "Thumbnail";
        s_dict[TaskCompanies] = "TaskCompanies";
        s_dict[LastReplyBy] = "LastReplyBy";
        s_dict[IMEComment2] = "IMEComment2";
        s_dict[ConnectionType] = "ConnectionType";
        s_dict[UserField3] = "UserField3";
        s_dict[BaseAssociationGuid] = "BaseAssociationGuid";
        s_dict[MyEditor] = "MyEditor";
        s_dict[V4SendTo] = "V4SendTo";
        s_dict[HasCustomEmailBody] = "HasCustomEmailBody";
        s_dict[WorkflowName] = "WorkflowName";
        s_dict[GbwCategory] = "GbwCategory";
        s_dict[MessageId] = "MessageId";
        s_dict[PreviewOnForm] = "PreviewOnForm";
        s_dict[Indentation] = "Indentation";
        s_dict[OtherAddressCountry] = "OtherAddressCountry";
        s_dict[EmailBody] = "EmailBody";
        s_dict[_Coverage] = "_Coverage";
        s_dict[fAllDayEvent] = "fAllDayEvent";
        s_dict[PendingModTime] = "PendingModTime";
        s_dict[BillingInformation] = "BillingInformation";
        s_dict[Combine] = "Combine";
        s_dict[URLwMenu] = "URLwMenu";
        s_dict[FullName] = "FullName";
        s_dict[OtherAddressPostalCode] = "OtherAddressPostalCode";
        s_dict[LinkFilename] = "LinkFilename";
        s_dict[HomeAddressCountry] = "HomeAddressCountry";
        s_dict[_EditMenuTableStart] = "_EditMenuTableStart";
        s_dict[_CopySource] = "_CopySource";
        s_dict[Author] = "Author";
        s_dict[EmailReferences] = "EmailReferences";
        s_dict[Department] = "Department";
        s_dict[HealthRuleVersion] = "HealthRuleVersion";
        s_dict[CustomerID] = "CustomerID";
        s_dict[Modified] = "Modified";
        s_dict[Priority] = "Priority";
        s_dict[RulesUrl] = "RulesUrl";
        s_dict[_Author] = "_Author";
        s_dict[AdminTaskAction] = "AdminTaskAction";
        s_dict[PersonViewMinimal] = "PersonViewMinimal";
        s_dict[HealthRuleAutoRepairEnabled] = "HealthRuleAutoRepairEnabled";
        s_dict[LinkDiscussionTitleNoMenu] = "LinkDiscussionTitleNoMenu";
        s_dict[Home2Number] = "Home2Number";
        s_dict[GovernmentIDNumber] = "GovernmentIDNumber";
        s_dict[Confirmations] = "Confirmations";
        s_dict[WorkflowTemplate] = "WorkflowTemplate";
        s_dict[XSLStyleIconUrl] = "XSLStyleIconUrl";
        s_dict[PublishedDate] = "PublishedDate";
        s_dict[OtherFaxNumber] = "OtherFaxNumber";
        s_dict[PrincipalCount] = "PrincipalCount";
        s_dict[ParentLeafName] = "ParentLeafName";
        s_dict[DisplayTemplateJSTargetControlType] = "DisplayTemplateJSTargetControlType";
        s_dict[XSLStyleBaseView] = "XSLStyleBaseView";
        s_dict[_Format] = "_Format";
        s_dict[NameOrTitle] = "NameOrTitle";
        s_dict[LeaveEarly] = "LeaveEarly";
        s_dict[WorkflowInstance] = "WorkflowInstance";
        s_dict[_SharedFileIndex] = "_SharedFileIndex";
        s_dict[PagerNumber] = "PagerNumber";
        s_dict[EncodedAbsWebImgUrl] = "EncodedAbsWebImgUrl";
        s_dict[Participants] = "Participants";
        s_dict[RepairDocument] = "RepairDocument";
        s_dict[HealthReportExplanation] = "HealthReportExplanation";
        s_dict[ContentType] = "ContentType";
        s_dict[_RightsManagement] = "_RightsManagement";
        s_dict[LinkDiscussionTitle2] = "LinkDiscussionTitle2";
        s_dict[Purpose] = "Purpose";
        s_dict[_LastPrinted] = "_LastPrinted";
        s_dict[PersonalWebsite] = "PersonalWebsite";
        s_dict[ConfirmedTo] = "ConfirmedTo";
        s_dict[Group] = "Group";
        s_dict[TaskDueDate] = "TaskDueDate";
        s_dict[ShowCombineView] = "ShowCombineView";
        s_dict[LinkTitleNoMenu] = "LinkTitleNoMenu";
        s_dict[FileDirRef] = "FileDirRef";
        s_dict[Name] = "Name";
        s_dict[TaskType] = "TaskType";
        s_dict[FileLeafRef] = "FileLeafRef";
        s_dict[TemplateUrl] = "TemplateUrl";
        s_dict[Overtime] = "Overtime";
        s_dict[AlternateThumbnailUrl] = "AlternateThumbnailUrl";
        s_dict[CallbackNumber] = "CallbackNumber";
        s_dict[Hobbies] = "Hobbies";
        s_dict[ShortComment] = "ShortComment";
        s_dict[_EditMenuTableStart2] = "_EditMenuTableStart2";
        s_dict[_UIVersionString] = "_UIVersionString";
        s_dict[WorkflowInstanceID] = "WorkflowInstanceID";
        s_dict[XMLTZone] = "XMLTZone";
        s_dict[EmailCalendarSequence] = "EmailCalendarSequence";
        s_dict[wic_System_Copyright] = "wic_System_Copyright";
        s_dict[Confidential] = "Confidential";
        s_dict[WorkflowLink] = "WorkflowLink";
        s_dict[ResolvedDate] = "ResolvedDate";
        s_dict[WorkZip] = "WorkZip";
        s_dict[EmailTo] = "EmailTo";
        s_dict[Suffix] = "Suffix";
        s_dict[LastNamePhonetic] = "LastNamePhonetic";
        s_dict[Category] = "Category";
        s_dict[V3Comments] = "V3Comments";
        s_dict[Mileage] = "Mileage";
        s_dict[Deleted] = "Deleted";
        s_dict[SortBehavior] = "SortBehavior";
        s_dict[WorkFax] = "WorkFax";
        s_dict[_Relation] = "_Relation";
        s_dict[CellPhone] = "CellPhone";
        s_dict[WorkspaceLink] = "WorkspaceLink";
        s_dict[ol_Department] = "ol_Department";
        s_dict[In] = "In";
        s_dict[EmailFrom] = "EmailFrom";
        s_dict[Office] = "Office";
        s_dict[CompanyNumber] = "CompanyNumber";
        s_dict[Facilities] = "Facilities";
        s_dict[HolidayNightWork] = "HolidayNightWork";
        s_dict[DiscussionTitleLookup] = "DiscussionTitleLookup";
        s_dict[FTPSite] = "FTPSite";
        s_dict[WorkCity] = "WorkCity";
        s_dict[XomlUrl] = "XomlUrl";
        s_dict[ContentTypeId] = "ContentTypeId";
        s_dict[UniqueId] = "UniqueId";
        s_dict[StatusBar] = "StatusBar";
        s_dict[EmailCalendarUid] = "EmailCalendarUid";
        s_dict[Vacation] = "Vacation";
        s_dict[FreeBusy] = "FreeBusy";
        s_dict[_Photo] = "_Photo";
        s_dict[Comment] = "Comment";
        s_dict[Overbook] = "Overbook";
        s_dict[NoCrawl] = "NoCrawl";
        s_dict[HealthRuleScope] = "HealthRuleScope";
        s_dict[TimeZone] = "TimeZone";
        s_dict[ISDNNumber] = "ISDNNumber";
        s_dict[RecurrenceData] = "RecurrenceData";
        s_dict[EMail] = "EMail";
        s_dict[_IsCurrentVersion] = "_IsCurrentVersion";
        s_dict[File_x0020_Size] = "File_x0020_Size";
        s_dict[WorkCountry] = "WorkCountry";
        s_dict[NightWork] = "NightWork";
        s_dict[AssociatedListId] = "AssociatedListId";
        s_dict[owshiddenversion] = "owshiddenversion";
        s_dict[AdminTaskOrder] = "AdminTaskOrder";
        s_dict[IsAnswered] = "IsAnswered";
        s_dict[LinkFilenameNoMenu] = "LinkFilenameNoMenu";
        s_dict[DueDate] = "DueDate";
        s_dict[Start] = "Start";
        s_dict[OtherAddressStateOrProvince] = "OtherAddressStateOrProvince";
        s_dict[ChildrensNames] = "ChildrensNames";
        s_dict[OtherAddressStreet] = "OtherAddressStreet";
        s_dict[ScopeId] = "ScopeId";
        s_dict[IconOverlay] = "IconOverlay";
        s_dict[Threading] = "Threading";
        s_dict[_DCDateCreated] = "_DCDateCreated";
        s_dict[JobTitle] = "JobTitle";
        s_dict[TaskStatus] = "TaskStatus";
        s_dict[Outcome] = "Outcome";
        s_dict[AssistantsName] = "AssistantsName";
        s_dict[MessageBody] = "MessageBody";
        s_dict[Initials] = "Initials";
        s_dict[IsSiteAdmin] = "IsSiteAdmin";
        s_dict[PermMask] = "PermMask";
        s_dict[RestrictContentTypeId] = "RestrictContentTypeId";
        s_dict[Data] = "Data";
        s_dict[BodyAndMore] = "BodyAndMore";
        s_dict[_Level] = "_Level";
        s_dict[ExtendedProperties] = "ExtendedProperties";
        s_dict[IsQuestion] = "IsQuestion";
        s_dict[EmailHeaders] = "EmailHeaders";
        s_dict[UIVersion] = "UIVersion";
        s_dict[_Version] = "_Version";
        s_dict[WorkflowAssociation] = "WorkflowAssociation";
        s_dict[_Contributor] = "_Contributor";
        s_dict[CompanyPhonetic] = "CompanyPhonetic";
        s_dict[ResolvedBy] = "ResolvedBy";
        s_dict[DecisionStatus] = "DecisionStatus";
        s_dict[Item] = "Item";
        s_dict[ServerUrl] = "ServerUrl";
        s_dict[AssistantNumber] = "AssistantNumber";
        s_dict[_UIVersion] = "_UIVersion";
        s_dict[EventCanceled] = "EventCanceled";
        s_dict[UID] = "UID";
        s_dict[ReplyNoGif] = "ReplyNoGif";
        s_dict[IsFeatured] = "IsFeatured";
        s_dict[BaseName] = "BaseName";
        s_dict[EmailSender] = "EmailSender";
        s_dict[Event] = "Event";
        s_dict[ParticipantsPicker] = "ParticipantsPicker";
        s_dict[IndentLevel] = "IndentLevel";
        s_dict[ActualWork] = "ActualWork";
        s_dict[V4CallTo] = "V4CallTo";
        s_dict[Occurred] = "Occurred";
        s_dict[EmailCc] = "EmailCc";
        s_dict[ToggleQuotedText] = "ToggleQuotedText";
        s_dict[LinkDiscussionTitle] = "LinkDiscussionTitle";
        s_dict[Title] = "Title";
        s_dict[CarNumber] = "CarNumber";
        s_dict[UserField2] = "UserField2";
        s_dict[fRecurrence] = "fRecurrence";
        s_dict[IssueStatus] = "IssueStatus";
        s_dict[ShowRepairView] = "ShowRepairView";
        s_dict[XSLStyleCategory] = "XSLStyleCategory";
        s_dict[BestAnswerId] = "BestAnswerId";
        s_dict[Subject] = "Subject";
        s_dict[Email3] = "Email3";
        s_dict[Anniversary] = "Anniversary";
        s_dict[Order] = "Order";
        s_dict[HealthRuleService] = "HealthRuleService";
        s_dict[TrimmedBody] = "TrimmedBody";
        s_dict[_Category] = "_Category";
        s_dict[FileRef] = "FileRef";
        s_dict[LimitedBody] = "LimitedBody";
        s_dict[ManagersName] = "ManagersName";
        s_dict[_Status] = "_Status";
        s_dict[MasterSeriesItemID] = "MasterSeriesItemID";
        s_dict[WorkflowListId] = "WorkflowListId";
        s_dict[Picture] = "Picture";
        s_dict[FormURN] = "FormURN";
        s_dict[TTYTDDNumber] = "TTYTDDNumber";
        s_dict[OtherNumber] = "OtherNumber";
        s_dict[Attachments] = "Attachments";
        s_dict[URLNoMenu] = "URLNoMenu";
        s_dict[HolidayDate] = "HolidayDate";
        s_dict[BodyWasExpanded] = "BodyWasExpanded";
        s_dict[PostCategory] = "PostCategory";
        s_dict[_ResourceType] = "_ResourceType";
        s_dict[Duration] = "Duration";
        s_dict[StartDate] = "StartDate";
        s_dict[xd_Signature] = "xd_Signature";
        s_dict[MobileContent] = "MobileContent";
        s_dict[Preview] = "Preview";
        s_dict[HealthRuleType] = "HealthRuleType";
        s_dict[ListType] = "ListType";
        s_dict[IMEPos] = "IMEPos";
        s_dict[Checkmark] = "Checkmark";
        s_dict[AppEditor] = "AppEditor";
        s_dict[DocIcon] = "DocIcon";
        s_dict[ParentVersionString] = "ParentVersionString";
        s_dict[HomeAddressPostalCode] = "HomeAddressPostalCode";
        s_dict[PersonImage] = "PersonImage";
        s_dict[UserField1] = "UserField1";
        s_dict[PreviouslyAssignedTo] = "PreviouslyAssignedTo";
        s_dict[_DCDateModified] = "_DCDateModified";
        s_dict[_Identifier] = "_Identifier";
        s_dict[GUID] = "GUID";
        s_dict[ProgId] = "ProgId";
        s_dict[Language] = "Language";
        s_dict[UserName] = "UserName";
        s_dict[OffsiteParticipantReason] = "OffsiteParticipantReason";
        s_dict[WorkAddress] = "WorkAddress";
        s_dict[_ModerationComments] = "_ModerationComments";
        s_dict[EventType] = "EventType";
        s_dict[Created] = "Created";
        s_dict[FolderChildCount] = "FolderChildCount";
        s_dict[CorrectBodyToShow] = "CorrectBodyToShow";
        s_dict[GbwLocation] = "GbwLocation";
        s_dict[InstanceID] = "InstanceID";
        s_dict[HomePhone] = "HomePhone";
        s_dict[WhatsNew] = "WhatsNew";
        s_dict[RelatedLinks] = "RelatedLinks";
        s_dict[Birthday] = "Birthday";
        s_dict[DiscussionLastUpdated] = "DiscussionLastUpdated";
        s_dict[DisplayTemplateJSTemplateHidden] = "DisplayTemplateJSTemplateHidden";
        s_dict[WikiField] = "WikiField";
        s_dict[Edit] = "Edit";
        s_dict[XSLStyleWPType] = "XSLStyleWPType";
        s_dict[FSObjType] = "FSObjType";
        s_dict[_EndDate] = "_EndDate";
        s_dict[ShortestThreadIndex] = "ShortestThreadIndex";
        s_dict[ol_EventAddress] = "ol_EventAddress";
        s_dict[TelexNumber] = "TelexNumber";
        s_dict[DisplayTemplateJSTemplateType] = "DisplayTemplateJSTemplateType";
        s_dict[HealthRuleCheckEnabled] = "HealthRuleCheckEnabled";
        s_dict[RequiredField] = "RequiredField";
        s_dict[IMAddress] = "IMAddress";
        s_dict[xd_ProgID] = "xd_ProgID";
        s_dict[TotalWork] = "TotalWork";
        s_dict[FileType] = "FileType";
        s_dict[Nickname] = "Nickname";
        s_dict[PrimaryNumber] = "PrimaryNumber";
        s_dict[ImageCreateDate] = "ImageCreateDate";
        s_dict[NumberOfVacation] = "NumberOfVacation";
        s_dict[SystemTask] = "SystemTask";
        s_dict[IsRootPost] = "IsRootPost";
        s_dict[Late] = "Late";
        s_dict[UserInfoHidden] = "UserInfoHidden";
        s_dict[Business2Number] = "Business2Number";
        s_dict[Created_x0020_By] = "Created_x0020_By";
        s_dict[FormData] = "FormData";
        s_dict[LinkTitle] = "LinkTitle";
        s_dict[IMEDisplay] = "IMEDisplay";
        s_dict[Notes] = "Notes";
        s_dict[_SourceUrl] = "_SourceUrl";
        s_dict[FileSizeDisplay] = "FileSizeDisplay";
        s_dict[HealthReportSeverityIcon] = "HealthReportSeverityIcon";
        s_dict[ThumbnailOnForm] = "ThumbnailOnForm";
        s_dict[WorkPhone] = "WorkPhone";
        s_dict[TaskGroup] = "TaskGroup";
        s_dict[HealthReportRemedy] = "HealthReportRemedy";
        s_dict[EmailCalendarDateStamp] = "EmailCalendarDateStamp";
        s_dict[MoreLink] = "MoreLink";
        s_dict[_Source] = "_Source";
        s_dict[MetaInfo] = "MetaInfo";
        s_dict[DateCompleted] = "DateCompleted";
        s_dict[Completed] = "Completed";
        s_dict[ItemChildCount] = "ItemChildCount";
        s_dict[SelectFilename] = "SelectFilename";
        s_dict[SurveyTitle] = "SurveyTitle";
        s_dict[DayOfWeek] = "DayOfWeek";
        s_dict[EncodedAbsUrl] = "EncodedAbsUrl";
        s_dict[DLC_Description] = "DLC_Description";
        s_dict[QuotedTextWasExpanded] = "QuotedTextWasExpanded";
        s_dict[IsActive] = "IsActive";
        s_dict[MUILanguages] = "MUILanguages";
        s_dict[HomeFaxNumber] = "HomeFaxNumber";
        s_dict[Categories] = "Categories";
        s_dict[ImageSize] = "ImageSize";
        s_dict[HealthReportServices] = "HealthReportServices";
        s_dict[HealthReportServers] = "HealthReportServers";
        s_dict[Content] = "Content";
        s_dict[Predecessors] = "Predecessors";
        s_dict[PreviewExists] = "PreviewExists";
        s_dict[LessLink] = "LessLink";
        s_dict[XSLStyleRequiredFields] = "XSLStyleRequiredFields";
        s_dict[IMEUrl] = "IMEUrl";
      }
    }
    ...
    public static bool Contains(Guid fid) {
      EnsureItems();
      string name;
      return (s_dict.TryGetValue(fid, out name));
    }
