...
//    using Kraken.SharePoint.Security;
  ...
  /// <summary>
  /// This class helps to read and write to the property bag of a SharePoint object.
  /// </summary>
    public class SPConfigurationReader {
      ...
      public bool ReadConfigSetting(SPWeb web, ConfigScope scope, string setting, Type type, out object value) {
        ...
        /// <param name="level">Scope at which valString is stored.</param>
        /// <param name="setting">Setting to change (propertyName)</param>
        /// <param name="valString">Returned valString</param>
        ...
        public bool ReadConfigSetting(SPWeb web,ConfigScope scope, string setting, out string value)
        {
            ...
            SPSecurity.RunWithElevatedPrivileges( //Delegation.RunWithElevatedPriviliges(web, 
              delegate {
        ...
        /// <summary>
        /// Writes a config valString to the web, site or farm
        /// </summary>
        ...
        /// <param name="valString">valString to write</param>
